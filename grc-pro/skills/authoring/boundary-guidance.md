...
2. **Read the appropriate reference files**:
   - `grc-pro/knowledge/audits/boundary-guidance.md` for boundary patterns, common mistakes, and diagram requirements
   - `grc-pro/knowledge/audits/control-inheritance.md` for inheritance context
