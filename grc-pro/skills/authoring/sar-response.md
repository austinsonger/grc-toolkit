...
2. **Read the appropriate reference files**:
   - `grc-pro/knowledge/audits/sar-response-patterns.md` for response templates and quality checklist
   - `grc-pro/knowledge/audits/document-section-requirements.md` for POA&M field requirements
   - `grc-pro/knowledge/conmon/poam-management.md` for severity SLAs
