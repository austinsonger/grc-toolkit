...
2. **Read the appropriate reference files**:
   - `grc-pro/knowledge/audits/control-inheritance.md` for inheritance patterns by service model
   - Framework file from `grc-pro/knowledge/frameworks/` for baseline control list
   - `grc-pro/knowledge/audits/document-section-requirements.md` for CRM structure guidance
