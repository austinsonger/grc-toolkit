...
2. **Read the appropriate reference files**:
   - `grc-pro/knowledge/audits/significant-change-criteria.md` for the decision criteria and category definitions
   - Framework file from `grc-pro/knowledge/frameworks/` if framework-specific parameters are needed
