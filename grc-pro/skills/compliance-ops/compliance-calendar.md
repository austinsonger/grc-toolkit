...
2. **Read the appropriate reference files**:
   - `grc-pro/knowledge/conmon/compliance-calendar.md` for consolidated calendar data
   - `grc-pro/knowledge/conmon/monthly-deliverables.md` for monthly detail
   - `grc-pro/knowledge/conmon/annual-deliverables.md` for annual detail
   - `grc-pro/knowledge/conmon/iscm-lifecycle.md` for lifecycle context
