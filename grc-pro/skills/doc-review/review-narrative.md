...
2. **Read the appropriate reference files**:
   - Framework file from `grc-pro/knowledge/frameworks/` for control details and ODP values
   - `grc-pro/knowledge/audits/narrative-quality-criteria.md` for scoring rubric
