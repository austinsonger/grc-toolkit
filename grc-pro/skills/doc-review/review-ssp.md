...
2. **Read the appropriate reference files**:
   - `grc-pro/knowledge/audits/document-section-requirements.md` for SSP section requirements
   - Framework file from `grc-pro/knowledge/frameworks/` for baseline-specific requirements
   - `grc-pro/knowledge/audits/narrative-quality-criteria.md` if reviewing narrative sections
