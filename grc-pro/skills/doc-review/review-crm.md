...
2. **Read the appropriate reference files**:
   - `grc-pro/knowledge/audits/document-section-requirements.md` for CRM requirements and expected distribution
   - Framework file from `grc-pro/knowledge/frameworks/` for baseline control list
   - `grc-pro/knowledge/audits/narrative-quality-criteria.md` for quality indicators
