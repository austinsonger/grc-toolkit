...
2. **Read the appropriate reference files**:
   - `grc-pro/knowledge/audits/document-section-requirements.md` for policy structural requirements
   - `grc-pro/knowledge/audits/narrative-quality-criteria.md` for language quality indicators
   - Framework file from `grc-pro/knowledge/frameworks/` for control family requirements
